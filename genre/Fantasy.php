...
$data_terbit = select("SELECT * FROM terbit WHERE disetujui=1 AND genre='Fantasy' ORDER BY judul DESC");
?>
          ...
          <?php if($terbit['premium']) : ?>
            ...
            <a href="../detail-komik.php?id_judul=<?= $terbit['id_judul'] ?>">
              ...
              <div class="card-body">
                ...
                <p class="card-text small">Viewed by user : <?= get_current_viewed_by_user($terbit['id_judul']); ?></p>
              </div>
            </a>
          </div>
        </div>
