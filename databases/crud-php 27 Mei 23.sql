...
(7, 'admin', 'admin', 'admin@gmail.com', '$2y$10$s0Kb/eu0DDpFdtLxMhmt/OIJPKUkSkXUOGbdb1N2RSpmcsva8cRN2', '1', 0),
(8, 'Dikan Rizaldy', 'DikanR', 'dikan42724@gmail.com', '$2y$10$A00/iglAjWGxQbDk9LT0T.5G1KChZ0G77IU33v/ELXHWuCacYiNiG', '3', 0);
...
INSERT INTO `membership` (`id_member`, `id_akun`, `nama`, `email`, `bank`, `struk`, `status`, `tgl_dibuat`, `tgl_disetujui`, `tgl_expired`) VALUES
(4, 4, 'test', 'test@gmail.com', 'BNI', '646ae118c4550.png', 1, '2023-05-04', '2023-05-04', '2023-05-04'),
(5, 4, 'test2', 'test2@gmail.com', 'BCA', '646b078f3a337.png', 0, '2023-05-04', '2023-05-04', '2023-05-04'),
(6, 5, 'Ryan', 'test2@gmail.com', 'BCA', '646c057f9d4b0.png', 0, '2023-05-04', '2023-05-04', '2023-05-04');
...
INSERT INTO `terbit` (`id_judul`, `id_akun`, `judul`, `genre`, `email`, `ringkasan`, `foto`, `disetujui`, `premium`, `tgl_dibuat`, `tgl_disetujui`) VALUES
(39, 6, 'The God High School', 'Action', 'user1@gmail.com', 'asdasd', '6465f9b70cff8.jpg', 1, 1, '2023-05-04', '2023-05-04'),
(40, 3, 'doom brekerrr', 'Action', 'user@gmail.com', 'asdasdasd', '6466bd4e706fe.jpeg', 1, 0, '2023-05-04', '2023-05-04'),
(41, 4, 'Illum eum dolorem d', 'Romantis', 'togi@mailinator.com', 'Et doloribus magna n', '6466d2b4ee900.jpg', 1, 0, '2023-05-04', '2023-05-04'),
(42, 3, 'Dolore deserunt volu', 'Comedy', 'jyvyw@mailinator.com', 'Distinctio Mollitia', '6466d8326ee6b.jpg', 0, 0, '2023-05-04', '2023-05-04'),
(43, 4, 'Voluptas iste sequi ', 'Comedy', 'zikavadec@mailinator.com', 'Corrupti quae velit', '6466d923e6746.jpg', 0, 0, '2023-05-04', '2023-05-04'),
(44, 6, 'Labore dolor omnis va', 'Romantis', 'podacogibi@mailinator.com', 'Sunt illum incidunt', '6466d9332f551.jpg', 0, 0, '2023-05-04', '2023-05-04'),
(45, 6, 'Ut reiciendis aute q', 'Comedy', 'talezavis@mailinator.com', 'Unde deserunt quasi ', '6466d96c0e45d.jpg', 1, 1, '2023-05-04', '2023-05-04'),
(46, 3, 'Aut aut perferendis ', 'Romantis', 'rivolisygu@mailinator.com', 'Velit qui eu dolorem', '6466d9a2d1f55.jpg', 1, 0, '2023-05-04', '2023-05-04'),
(47, 4, 'At ipsum id est et ', 'Horor', 'kutatimagy@mailinator.com', 'Ullam illum laudant', '6467352a194e3.png', 0, 0, '2023-05-04', '2023-05-04'),
(48, 4, 'Sunt et placeat qui', 'Fantasy', 'qitoxezex@mailinator.com', 'Quaerat Nam architec', '64681bea2964a.png', 1, 0, '2023-05-04', '2023-05-04'),
(49, 6, 'Culpa quis qui in laa', 'Comedy', 'gexu@mailinator.com', 'A in ad dolor eius a', '64682a3e73528.png', 0, 0, '2023-05-04', '2023-05-04'),
(50, 6, 'Eum deserunt consequ', 'Fantasy', 'beti@mailinator.com', 'Nobis ut et autem as', '64682b1d2d603.png', 0, 0, '2023-05-04', '2023-05-04'),
(51, 6, 'Nostrum magna repudi', 'Horor', 'tosybomi@mailinator.com', 'Voluptatem quia modi', '64686727bd31c.png', 0, 1, '2023-05-04', '2023-05-04');

-- --------------------------------------------------------

--
-- Table structure for table `viewed_by_user`
--

CREATE TABLE `viewed_by_user` (
  `id_viewed_by_user` int NOT NULL,
...
--
-- Table structure for table `arsip_penarikan_uang`
--

CREATE TABLE `arsip_penarikan_uang` (
  `id_arsip_penarikan_uang` int NOT NULL PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE `membership_tier` (
  `id_membership_tier` int NOT NULL,
  `harga` int NOT NULL,
  `nama` varchar(100) NOT NULL,
  `keuntungan` json NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `membership_tier` (`id_membership_tier`,`harga`, `nama`) VALUES
(1, 299000, 'Standar'),
(2, 399000, 'Medium is premium');
...
--
-- Indexes for table `viewed_by_user`
--
ALTER TABLE `viewed_by_user`
  ADD PRIMARY KEY (`id_viewed_by_user`);

--
-- Indexes for table `membership_tier`
--
ALTER TABLE `membership_tier`
  ADD PRIMARY KEY (`id_membership_tier`);
...
--
-- AUTO_INCREMENT for table `viewed_by_user`
--
ALTER TABLE `viewed_by_user`
  MODIFY `id_viewed_by_user` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;

--
-- AUTO_INCREMENT for table `membership_tier`
--
ALTER TABLE `membership_tier`
  MODIFY `id_membership_tier` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=0;
COMMIT;
