...
echo "<script>
  ...
  $title = 'Laporan Membership Aktif';
...
<div class="container mt-5">
  <div class="d-flex justify-content-between">
    <h1><i class="fas fa-list"></i>  Laporan Membership Aktif</h1>
    <div>
      <a href="membership-print.php" target="_blank" class="btn btn-primary">Print</a>
    </div>
  </div>
  <hr>
...
aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
        ...
        <input type="hidden" name="id_akun" value="<?= $akun['id_akun']; ?>">
            ...
            <div class="mb-3">
                <label for="password">Password 
                    <small>(Masukan password baru)</small>
                </label>
                <input type="password" name="password" id="password" class="form-control" 
                required minlength="6">
            </div>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Kembali</button>
        <button type="ubah" name="ubah" class="btn btn-success">Ubah</button>
      </div>
      </form>
    </div>
  </div>
...
aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>Yakin anda menghapus akun : <?= $akun['nama']; ?> .? </p>
